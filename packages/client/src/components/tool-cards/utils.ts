...
export const DIFF_VIEWER_STYLES = {
  variables: {
    light: {
      ...
      addedBackground: 'hsl(var(--diff-added) / 0.15)',
      addedColor: 'hsl(var(--diff-added))',
      removedBackground: 'hsl(var(--diff-removed) / 0.15)',
      removedColor: 'hsl(var(--diff-removed))',
      wordAddedBackground: 'hsl(var(--diff-added) / 0.3)',
      wordRemovedBackground: 'hsl(var(--diff-removed) / 0.3)',
      addedGutterBackground: 'hsl(var(--diff-added) / 0.1)',
      removedGutterBackground: 'hsl(var(--diff-removed) / 0.1)',
